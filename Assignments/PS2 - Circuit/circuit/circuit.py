...
class PriorityQueue:
    ...
    def pop(self):
        return self._findRmvMin()

    def _child(self, pos, left=True):
    ...
    def checkMinHeapRI(self):
        ...
        p = 0
        while True:
            l, r = self._child(p), self._child(p, False)
