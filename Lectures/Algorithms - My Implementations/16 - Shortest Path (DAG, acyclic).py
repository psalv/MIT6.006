...
def shortestPathDAG(graph, start, end):
    ...
    ordr = []
    while endPointer.pi != None:
        ordr.append(endPointer)
        endPointer = endPointer.pi
    ordr.append(endPointer)
    ordr = ordr[::-1]
    return ordr
